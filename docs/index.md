...
- [**Lesson 1.1 — What Is a Parallel Kinematics Machine?**](module01/1-1-what-is-a-pkm.md) — the orientation lesson and the prototype of the full student experience (reading, diagram, interactive demo, notebook verification, and knowledge check).
...
- a **notebook** (N1–N5) that reproduces every number from the simulator's exported data,
...
| **The project handbook** | the operational reference for the artifacts | [Kinematics](handbook/02-kinematic-twin.md) · [Hydraulics](handbook/03-hydraulic-twin.md) · [Control](handbook/04-control-twin.md) · [Wiring](handbook/06-wiring-and-io-appendix.md) |
